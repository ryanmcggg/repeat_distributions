...
def parse(filename, inner_filename = False) -> Record:
    """Determines the compression type of a file and yields FASTA records.

    Args:
        filename: a name [pathlib.Path currently not implemented] of a file containing FASTA sequences
        inner_filename: the name of a particular FASTA file within a .zip archive (optional)
    ...
    if compression_type == 'bz2':
        ...
        with zipfile.ZipFile(filename) as z:
            ...
            if inner_filename == False:
                inner_filename = z.namelist()[0]
            # Otherwise, use the provided inner_filename
