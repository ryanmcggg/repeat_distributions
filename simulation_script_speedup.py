...
#        A_B_into_L1 = -A_mut_out_fission.sum()
    ...
    boundary_flag = ((A_count_output[A_bins-1] > 100) | (B_count_output[B_bins-1] >100))
...
def run_simulation_custom(mult, exp_power, con_power, max_speedup = 5, rounds_mult = 0, fill = False, nonexp_factor = False, A_bins = 100, B_bins = 100, input_nuc = 'A', mutonly = False, stochastics = None, boot = None, overwrite = False, random_start = False, subonly_start = True, reflective = True, sim_dir = 'simulations/toy_output/'):
